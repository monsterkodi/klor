...
kolorize = function (chunk)
{
    ...
    if (cn = kolor.map[chunk.clss])
    {
        if (cn instanceof Array)
        {
            ...
            for (var _1314_19_ = 0; _1314_19_ < list2.length; _1314_19_++)
            {
                cr = list2[_1314_19_]
                v = kolor[cr](v)
            }
...
kolorizeChunks = function (chunks = [], number)
{
    ...
    if (number)
    {
        ...
        clrzd += _k_.w2(numstr) + rpad(4 - numstr.length)
    }
    c = 0
    for (var _1343_14_ = i = 0, _1343_18_ = chunks.length; (_1343_14_ <= _1343_18_ ? i < chunks.length : i > chunks.length); (_1343_14_ <= _1343_18_ ? ++i : --i))
    {
...
syntax = function (arg)
{
    var clines, index, lines, numbers, rngs, text, _1360_19_, _1361_25_

    arg = (arg != null ? arg : {})
    text = arg.text
    ext = ((_1360_19_=arg.ext) != null ? _1360_19_ : 'coffee')
    numbers = ((_1361_25_=arg.numers) != null ? _1361_25_ : false)
    ...
    clines = []
    for (var _1366_18_ = index = 0, _1366_22_ = lines.length; (_1366_18_ <= _1366_22_ ? index < lines.length : index > lines.length); (_1366_18_ <= _1366_22_ ? ++index : --index))
    {
        line = lines[index]

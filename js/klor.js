...
var actExt, addValue, addValues, blockComment, blocked, chunk, chunked, chunkIndex, codeTypes, coffeePunct, coffeeWord, commentHeader, cppMacro, cppPointer, cppWord, cssWord, dashArrow, dict, escape, ext, exts, extStack, extTop, fillComment, float, FLOAT, getChunk, getmatch, getValue, handl, handlers, hashComment, HEADER, HEX, HEXNUM, interpolation, jsonPunct, jsonWord, jsPunct, jsWord, keyword, kodePunct, kodeWord, kolor, kolorize, kolorizeChunks, lang, LI, line, mdPunct, mmMacro, NEWLINE, noonComment, noonProp, noonPunct, noonWord, notCode, number, NUMBER, obj, parse, popExt, popStack, property, PUNCT, pushExt, pushStack, regexp, replaceTabs, setValue, shPunct, simpleString, slashComment, SPACE, stack, stacked, stackTop, starComment, swtch, syntax, thisCall, topType, tripleRegexp, tripleString, urlPunct, urlWord, xmlPunct
...
shPunct = function ()
{
    var _1058_42_, _1058_64_, _1061_102_, _1061_41_, _1061_82_, _1067_102_, _1067_41_, _1067_82_
...
getValue = function (d)
{
    var _1128_29_, _1128_36_

    return ((_1128_36_=(getChunk(d) != null ? getChunk(d).clss : undefined)) != null ? _1128_36_ : '')
}

getmatch = function (d)
{
    var _1129_29_, _1129_37_

    return ((_1129_37_=(getChunk(d) != null ? getChunk(d).match : undefined)) != null ? _1129_37_ : '')
}
...
addValues = function (n, value)
{
    ...
    for (var _1136_14_ = i = 0, _1136_18_ = n; (_1136_14_ <= _1136_18_ ? i < n : i > n); (_1136_14_ <= _1136_18_ ? ++i : --i))
    {
        addValue(i,value)
    }
    return n
...
for (var _1179_8_ = 0; _1179_8_ < list1.length; _1179_8_++)
{
    ext = list1[_1179_8_]
...
{
    var advance, beforeIndex, hnd, mightBeHeader, mtch, turdChunk, _1271_40_, _1286_61_
    ...
    for (var _1222_13_ = 0; _1222_13_ < list2.length; _1222_13_++)
    {
        line = list2[_1222_13_]
        if (stackTop)
        {
            if (stackTop.type === 'comment triple')
            {
                ...
                for (var _1229_26_ = 0; _1229_26_ < list3.length; _1229_26_++)
                {
                    chunk = list3[_1229_26_]
                    if (!HEADER.test(chunk.match))
                    {
                        mightBeHeader = false
                        break
                ...
                if (mightBeHeader)
                {
                    ...
                    for (var _1234_30_ = 0; _1234_30_ < list4.length; _1234_30_++)
                    {
                        chunk = list4[_1234_30_]
                        chunk.clss = 'comment triple header'
                    }
                    continue
                }
        ...
        if (ext !== line.ext)
        {
            ...
            if (!handl)
            {
                _k_.dbg("kode/klor.kode", 1251, 16, "ext", ext)
                _k_.dbg("kode/klor.kode", 1252, 16, "line", line)
                _k_.dbg("kode/klor.kode", 1253, 16, null, handlers[ext])
            }
        }
        chunkIndex = 0
        while (chunkIndex < line.chunks.length)
        {
            ...
            if (chunk.clss.startsWith('punct'))
            {
                ...
                for (var _1275_24_ = 0; _1275_24_ < list5.length; _1275_24_++)
                {
                    hnd = list5[_1275_24_]
                    if (advance = hnd())
                    {
            ...
            else
            {
                if (!notCode)
                {
                    if (mtch = (swtch[line.ext] != null ? swtch[line.ext][chunk.match] : undefined))
                    {
                        if (mtch.turd)
                        {
                            ...
                            if (mtch.turd === (((_1286_61_=(turdChunk != null ? turdChunk.turd : undefined)) != null ? _1286_61_ : (turdChunk != null ? turdChunk.match : undefined))))
                            {
                                pushExt(mtch)
                            }
                        }
                ...
                for (var _1292_24_ = 0; _1292_24_ < list6.length; _1292_24_++)
                {
                    hnd = list6[_1292_24_]
                    if (advance = hnd())
                    {
...
kolorize = function (chunk)
{
    ...
    if (cn = kolor.map[chunk.clss])
    {
        if (cn instanceof Array)
        {
            ...
            for (var _1328_19_ = 0; _1328_19_ < list2.length; _1328_19_++)
            {
                cr = list2[_1328_19_]
                v = kolor[cr](v)
            }
...
kolorizeChunks = function (chunks = [], number)
{
    ...
    c = 0
    for (var _1357_14_ = i = 0, _1357_18_ = chunks.length; (_1357_14_ <= _1357_18_ ? i < chunks.length : i > chunks.length); (_1357_14_ <= _1357_18_ ? ++i : --i))
    {
...
syntax = function (arg)
{
    var clines, index, lines, numbers, rngs, text, _1374_19_, _1375_25_

    arg = (arg != null ? arg : {})
    text = arg.text
    ext = ((_1374_19_=arg.ext) != null ? _1374_19_ : 'coffee')
    numbers = ((_1375_25_=arg.numers) != null ? _1375_25_ : false)
    ...
    clines = []
    for (var _1380_18_ = index = 0, _1380_22_ = lines.length; (_1380_18_ <= _1380_22_ ? index < lines.length : index > lines.length); (_1380_18_ <= _1380_22_ ? ++index : --index))
    {
        line = lines[index]

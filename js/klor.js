...
simpleString = function() {
    ...
    if (ref2 = chunk.match, indexOf.call('"\'', ref2) >= 0) {
        ...
        if (chunk.match === "'") {
            next = getChunk(1);
            if ((ref3 = next != null ? next.match : void 0) === 's' || ref3 === 'll' || ref3 === 'd' || ref3 === 't') {
                scnd = getChunk(2);
                if (!scnd || scnd.match !== "'") {
                    return stacked();
                }

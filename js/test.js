...
module.exports["ranges"] = function ()
{
    ...
    section("coffee function", function ()
    {
        lang('coffee')
    ...
    section("coffee method", function ()
    {
        lang('coffee')
        rgs = ranges(" a: =>")
        compare(inc(rgs,1,"a"),'method')
        compare(inc(rgs,2,":"),'punct method')
        compare(inc(rgs,4,"="),'punct function bound tail')
        compare(inc(rgs,5,">"),'punct function bound head')
        rgs = ranges(" a: ->")
        compare(inc(rgs,1,"a"),'method')
        compare(inc(rgs,2,":"),'punct method')
        compare(inc(rgs,4,"-"),'punct function tail')
        compare(inc(rgs,5,">"),'punct function head')
        rgs = ranges("mthd:  (arg)    => @member memarg")
        compare(inc(rgs,0,'mthd'),'method')
        compare(inc(rgs,4,':'),'punct method')
        compare(inc(rgs,16,'='),'punct function bound tail')
        compare(inc(rgs,17,'>'),'punct function bound head')
        rgs = ranges("@mthd: (arg) ->")
        compare(inc(rgs,0,'@'),'punct method class')
        compare(inc(rgs,1,'mthd'),'method class')
    })
    section("koffee constructor", function ()
    {
        lang('coffee')
        rgs = ranges(" @: ->")
        ...
        compare(inc(rgs,1,"@"),'method')
        compare(inc(rgs,2,":"),'punct method')
        compare(inc(rgs,3,"-"),'punct function tail')
        compare(inc(rgs,4,">"),'punct function head')
    })
    section("koffee meta if then else", function ()
    {
        lang('coffee')
        rgs = ranges("▸if ▸then ▸elif ▸else")
        compare(inc(rgs,0,"▸"),'punct meta')
        compare(inc(rgs,1,"if"),'meta')
        compare(inc(rgs,4,"▸"),'punct meta')
        compare(inc(rgs,5,"then"),'meta')
        compare(inc(rgs,10,"▸"),'punct meta')
        compare(inc(rgs,11,"elif"),'meta')
        compare(inc(rgs,16,"▸"),'punct meta')
        compare(inc(rgs,17,"else"),'meta')
    })
    section("koffee no comma", function ()
    {
        lang('coffee')

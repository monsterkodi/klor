...
var dissect, ext, inc, klor, kxk, lang, nut, parse, ranges, _
...
inc = function (rgs, start, match, clss)
{
    ...
    }).should.deep.include({start:start,match:match,clss:clss})
}
...
nut = function (rgs, start, match, clss)
{
    ...
    {
        return _.pick(r,['start','match','clss'])
    }).should.not.deep.include({start:start,match:match,clss:clss})
}
ext = 'coffee'
...
describe('ranges',function ()
{
    ...
    it('comments',function ()
    {
        ...
        for (var _104_16_ = 0; _104_16_ < list.length; _104_16_++)
        {
            rng = list[_104_16_]
...
describe('parse',function ()
{
    ...
    {
        lang('coffee')
        parse("##").should.eql([{ext:'coffee',chars:2,index:0,number:1,chunks:[{start:0,length:1,match:"#",clss:'punct comment',turd:"##"},{start:1,length:1,match:"#",clss:'comment'}]}])
        return parse(",#a").should.eql([{ext:'coffee',chars:3,index:0,number:1,chunks:[{start:0,length:1,match:",",clss:'punct minor',turd:",#"},{start:1,length:1,match:"#",clss:'punct comment'},{start:2,length:1,match:"a",clss:'comment'}]}])
    })
    it('function',function ()
    {
        parse('->').should.eql([{ext:'coffee',chars:2,index:0,number:1,chunks:[{start:0,length:1,match:'-',clss:'punct function tail',turd:'->'},{start:1,length:1,match:'>',clss:'punct function head'}]}])
        parse('=>').should.eql([{ext:'coffee',chars:2,index:0,number:1,chunks:[{start:0,length:1,match:'=',clss:'punct function bound tail',turd:'=>'},{start:1,length:1,match:'>',clss:'punct function bound head'}]}])
        return parse('f=->1').should.eql([{ext:'coffee',chars:5,index:0,number:1,chunks:[{start:0,length:1,match:'f',clss:'function'},{start:1,length:1,match:'=',clss:'punct function',turd:'=->'},{start:2,length:1,match:'-',clss:'punct function tail',turd:'->'},{start:3,length:1,match:'>',clss:'punct function head'},{start:4,length:1,match:'1',clss:'number'}]}])
    })
    it('minimal',function ()
    {
        ...
        parse('1.a').should.eql([{ext:'coffee',chars:3,index:0,number:1,chunks:[{start:0,length:1,match:'1',clss:'number'},{start:1,length:1,match:'.',clss:'punct property'},{start:2,length:1,match:'a',clss:'property'}]}])
        parse('++a').should.eql([{ext:'coffee',chars:3,index:0,number:1,chunks:[{start:0,length:1,match:'+',clss:'punct',turd:'++'},{start:1,length:1,match:'+',clss:'punct'},{start:2,length:1,match:'a',clss:'text'}]}])
        return parse("▸doc 'hello'").should.eql([{ext:'coffee',chars:12,index:0,number:1,chunks:[{start:0,length:1,match:'▸',clss:'punct meta'},{start:1,length:3,match:'doc',clss:'meta'},{start:5,length:1,match:"'",clss:'punct string single'},{start:6,length:5,match:"hello",clss:'string single'},{start:11,length:1,match:"'",clss:'punct string single'}]}])
    })
    it('space',function ()
    {
        var b

...
\`\`\``)
    ...
    section("mm", function ()
    {
        ...
        {
            rgs = ranges('@"X"')
            compare(inc(rgs,0,"@"),'punct string double nsstring')
            compare(inc(rgs,1,'"'),'punct string double nsstring')
            compare(inc(rgs,2,'X'),'string double nsstring')
            compare(inc(rgs,3,'"'),'punct string double nsstring')
            rgs = ranges('@"%@"')
            compare(inc(rgs,0,"@"),'punct string double nsstring')
            compare(inc(rgs,1,'"'),'punct string double nsstring')
            compare(inc(rgs,2,'%@'),'string double nsstring')
            compare(inc(rgs,4,'"'),'punct string double nsstring')
        })
    })
    section("sh", function ()
    {
